    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dance_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='noti_class', to='class.class')),
